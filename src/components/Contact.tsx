              ...
              <div className="flex gap-4">
                ...
                {['github', 'twitter', 'linkedin', 'dribbble'].map((social) => (
                  <a 
                    key={social}
                    href="#" 
                    className="bg-white p-2 rounded-full text-portfolio-blue hover:text-portfolio-accent transition-colors"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <Textarea
                    ...
                    onChange={handleChange}
                    required
                    className="min-h-[150px] border-gray-300 focus-visible:ring-portfolio-accent"
                  />
                </div>
                <Button 
                  type="submit" 
                  className="w-full bg-portfolio-blue hover:bg-portfolio-accent text-white flex items-center justify-center gap-2"
                >
                  <Send size={16} />
                  Send Message
                </Button>
